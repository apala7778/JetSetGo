                    ...
                    <div className='mt-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6'>
                      ...
                      { addedPhotos.length > 0 && addedPhotos.map(link=> (
                         <div className='h-32 flex relative' key={link} >
                            ...
                            <img className='rounded-2xl w-full object-cover gap-2 ' src={'http://127.0.0.1:4000/uploads/'+link} alt="photos" /> 
                        ...
                        <label className=' cursor-pointer flex justify-center items-center gap-1 border bg-transparent rounded-2xl  text-2xl text-gray-600 w-100 py-10' > 
